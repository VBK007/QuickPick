...
import com.example.quickpick.Admin.Adminactivity
    ...
    private val listener = View.OnClickListener { view ->
        when (view.id) {
            ...
            R.id.loginbutton -> {
                ...
                var adminemail="kbharath32@gmail.com"
                var password="1234"
        ...
        if (TextUtils.isDigitsOnly(editemail.text.toString()) || TextUtils.isDigitsOnly(editpass.text.toString())) {
            ...
            auth.signInWithEmailAndPassword(editemail.text.toString(), editpass.text.toString())
                .addOnSuccessListener {
                    val reference = database.reference.child(Commmon.DRIVER_INFO_REFERENCE).child(
                        FirebaseAuth
                    ...
                    reference.addListenerForSingleValueEvent(object : ValueEventListener {
                        ...
                        override fun onDataChange(snapshot: DataSnapshot) {
                            ...
                            finish()
                            Toast.makeText(this@loginactivity, "Login Sucess", Toast.LENGTH_SHORT)
                                .show()
                        }
